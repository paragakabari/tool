...
export default function GeomatricSeries() {
    ...
    <>
        ...
        <div className="aritmetic-two-col-grid">
          <div className="aritmetic-two-col-grid-items">
            ...
            <div className="input-new">
              <label>First term of the geometric progression.</label>
              <input
                type="number"
                name="startNumber"
          ...
          <div className="aritmetic-two-col-grid-items">
            <div className="input-new"></div>
            <div className="input-new">
              <label>Multiply the following value by this ratio.</label>
              <input
                type="number"
                name="increaseNumber"
      ...
      <div className="main-globally-counter-box">
        ...
        <div className="counter-text-area">
          <textarea value={textValue} placeholder={placeHolder.output} disabled={true}
           style={{color:"black"}}
           />
        </div>
      </div>}
