    ...
    <div style={{ cursor: "pointer" }}>
      <div className="container-md">
        <div className={styles.privatePolicySection}>
          <h1>Privacy Policy for Convertor Tools</h1>
          <div className={styles.privatePolicyDetailsAlignment}>
            <p>
              At Convertor.tools, accessible from https://convertor.tools/, one
              of our main priorities is the privacy of our visitors. This
              Privacy Policy document contains types of information that is
              collected and recorded by Convertor.tools and how we use it.
            </p>
            ...
            <p>
              ...
              that they shared and/or collect in Convertor.tools. This policy is
          ...
          <div className={styles.privatePolicyDetailsAlignment}>
            ...
            <p>
              Convertor.tools follows a standard procedure of using log files.
          ...
          <div className={styles.privatePolicyDetailsAlignment}>
            ...
            <p>
              ...
              the advertising partners of Convertor.tools.
            </p>
            ...
            <p>
              ...
              Convertor.tools, which are sent directly to users' browser. They
            ...
            <p>
              Note that Convertor.tools has no access to or control over these
          ...
          <div className={styles.privatePolicyDetailsAlignment}>
            ...
            <p>
              Convertor.tools's Privacy Policy does not apply to other
          ...
          <div className={styles.privatePolicyDetailsAlignment}>
            ...
            <p>
              Convertor.tools does not knowingly collect any Personal
